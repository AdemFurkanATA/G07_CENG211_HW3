...
public class Food implements ITerrainObject {
     ...
     */
    public Food(PositionTest position, FoodType type, int weight) {
        if (position == null) {
     ...
     */
    public static Food createRandom(PositionTest position) {
        if (position == null) {
     ...
     * @throws IllegalArgumentException if any parameter is invalid
     */
    public static Food create(PositionTest position, FoodType type, int weight) {
     ...
     */
    public Food copyAtPosition(PositionTest newPosition) {
        if (newPosition == null) {
