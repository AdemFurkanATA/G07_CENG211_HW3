...
import com.enums.DirectionTest;
import com.enums.PenguinTypeTest;
import com.food.FoodTest;
...
public abstract class Penguin implements ITerrainObject, ISlidable {
    ...
    protected PenguinTypeTest type;                  // Type of penguin
    protected List<FoodTest> collectedFood;          // Food items collected
    ...
    protected DirectionTest slidingDirection;        // Current sliding direction
     ...
     */
    public Penguin(String name, PositionTest position, PenguinTypeTest type) {
     ...
     */
    @Override
    public void slide(DirectionTest direction) {
        this.isSliding = true;
     ...
     */
    @Override
    public DirectionTest getSlidingDirection() {
     ...
     */
    @Override
    public void setSlidingDirection(DirectionTest direction) {
        this.slidingDirection = direction;
    }
     ...
     */
    public PenguinTypeTest getType() {
        return type;
    }
     ...
     */
    public void collectFood(FoodTest food) {
        if (food == null) {
     ...
     */
    public List<FoodTest> getCollectedFood() {
    ...
    public int getTotalFoodWeight() {
        int total = 0;
        for (FoodTest food : collectedFood) {
     ...
     */
    public FoodTest removeLightestFood() {
        if (collectedFood.isEmpty()) {
            return null;
        }

        FoodTest lightest = collectedFood.get(0);
        for (FoodTest food : collectedFood) {
     ...
     */
    public FoodTest getFoodAt(int index) {
